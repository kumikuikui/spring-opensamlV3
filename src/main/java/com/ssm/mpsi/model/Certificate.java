...
public class Certificate {
    ...
    public void loadCertificate(String certificate) throws CertificateException {
        ...
        ByteArrayInputStream bais = (certificate.startsWith("---")) ? new ByteArrayInputStream(certificate.getBytes())
                : new ByteArrayInputStream(Base64.decodeBase64(certificate.getBytes()));
